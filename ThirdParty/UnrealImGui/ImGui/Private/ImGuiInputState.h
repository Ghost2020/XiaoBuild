...
public:
	...
	void SetKeyDown(const FKeyEvent& KeyEvent, const bool bIsDown) { SetKeyDown(ImGuiInterops::GetKeyIndex(KeyEvent), bIsDown); }

	// Change state of the key in the keys array and expand range bounding dirty part of the array.
	// @param Key - Keyboard key
	// @param bIsDown - True, if key is down
	void SetKeyDown(const FKey& Key, const bool bIsDown) { SetKeyDown(ImGuiInterops::GetKeyIndex(Key), bIsDown); }
	...
	void SetMouseDown(const FPointerEvent& MouseEvent, const bool bIsDown) { SetMouseDown(ImGuiInterops::GetMouseIndex(MouseEvent), bIsDown); }

	// Change state of the button in the mouse buttons array and expand range bounding dirty part of the array.
	// @param MouseButton - Mouse button key
	// @param bIsDown - True, if button is down
	void SetMouseDown(const FKey& MouseButton, const bool bIsDown) { SetMouseDown(ImGuiInterops::GetMouseIndex(MouseButton), bIsDown); }
	...
	void AddMouseWheelDelta(const float DeltaValue) { MouseWheelDelta += DeltaValue; }
	...
	void SetMousePointer(const bool bInHasMousePointer) { bHasMousePointer = bInHasMousePointer; }
	...
	void SetControlDown(const bool bIsDown) { bIsControlDown = bIsDown; }
	...
	void SetShiftDown(const bool bIsDown) { bIsShiftDown = bIsDown; }
	...
	void SetAltDown(const bool bIsDown) { bIsAltDown = bIsDown; }
	...
	// @param bIsDown - True, if key is down
	void SetGamepadNavigationKey(const FKeyEvent& KeyEvent, const bool bIsDown) { ImGuiInterops::SetGamepadNavigationKey(NavigationInputs, KeyEvent.GetKey(), bIsDown); }
	...
	void SetGamepadNavigationAxis(const FAnalogInputEvent& AnalogInputEvent, const float Value) { ImGuiInterops::SetGamepadNavigationAxis(NavigationInputs, AnalogInputEvent.GetKey(), Value); }
	...
	void SetKeyboardNavigationEnabled(const bool bEnabled) { bKeyboardNavigationEnabled = bEnabled; }
	...
	// @param bEnabled - True, if navigation is enabled
	void SetGamepadNavigationEnabled(const bool bEnabled) { bGamepadNavigationEnabled = bEnabled; }
	...
	void SetGamepad(const bool bInHasGamepad) { bHasGamepad = bInHasGamepad; }
