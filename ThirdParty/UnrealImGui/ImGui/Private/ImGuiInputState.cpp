...
void FImGuiInputState::AddCharacter(const TCHAR Char)
{
	InputCharacters.Add(Char);
}

void FImGuiInputState::SetKeyDown(const uint32 KeyIndex, const bool bIsDown)
{
...
void FImGuiInputState::SetMouseDown(const uint32 MouseIndex, const bool bIsDown)
{
