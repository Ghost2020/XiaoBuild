...
if (NOT QT_NO_CREATE_TARGETS AND Qt6EglFSDeviceIntegrationPrivate_FOUND)
    ...
    if(NOT Qt6EglFSDeviceIntegrationPrivate_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6EglFSDeviceIntegrationPrivate_DEFINITIONS)
        ...
        endforeach()
        set(Qt6EglFSDeviceIntegrationPrivate_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::EglFSDeviceIntegrationPrivate)
    ...
    if(NOT "EglFSDeviceIntegrationPrivate" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6EglFSDeviceIntegrationPrivateVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
