/**
  ...
  * @date 5:57 PM
 */
#include "SLicenseExclamationDialog.h"
...
#define LOCTEXT_NAMESPACE "SLicenseExclamationDialog"

BEGIN_SLATE_FUNCTION_BUILD_OPTIMIZATION
void SLicenseExclamationDialog::Construct(const FArguments& InArgs)
{
	...
	.Title(LOCTEXT("LicenseValidation_Title", "许可验证失败"))
